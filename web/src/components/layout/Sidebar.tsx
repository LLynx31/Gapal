...
import { useAuthStore, canAccessOrders, canAccessStock, canAccessAdmin } from '@/lib/auth';

const navigation = [
  { name: 'Tableau de bord', href: '/dashboard', icon: DashboardIcon, access: () => true },
  { name: 'Commandes', href: '/orders', icon: ClipboardIcon, access: canAccessOrders },
  { name: 'Stocks', href: '/stock', icon: CubeIcon, access: canAccessStock },
  { name: 'Produits', href: '/stock/products', icon: TagIcon, access: canAccessStock },
  { name: 'Rapports', href: '/reports/orders', icon: ChartIcon, access: canAccessOrders },
  { name: 'Administration', href: '/admin', icon: CogIcon, access: canAccessAdmin },
];
